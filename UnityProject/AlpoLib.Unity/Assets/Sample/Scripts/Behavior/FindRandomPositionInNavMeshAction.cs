...
namespace alpoLib.Sample.Behavior
{
    ...
    [NodeDescription(name: "FindRandomPositionInNavMesh",
        story: "[Self] 가 이동할 수 있는 랜덤 위치를 찾아 [TargetPosition] 에 지정합니다.", category: "Action",
        id: "6747dd2665d5a2e120007a4dc9d9fae0")]
